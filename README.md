...
### v1.0.6 (01.05.2026)
- ✅ Исправлены ошибки компиляции в IRDBRepositoryImpl.kt
- ✅ Временно отключены нереализованные функции (Flipper-IRDB, поиск онлайн)

### v1.0.5 (01.05.2026)
- ✅ Исправлена синтаксическая ошибка в IRDBRepositoryImpl.kt
- ✅ Удалён дублирующийся код обработки ошибок

### v1.0.4 (01.05.2026)
- ✅ Обновлена документация (ROADMAP, PROJECT_STRUCTURE)
- ✅ Удалены лишние MD файлы
- ✅ Настроено автоматическое версионирование (+0.0.1 с каждым изменением)

### v1.0.3 (01.05.2026)
- ✅ Обновлён SDK на Android 16 (API 36)

### v1.0.2 (01.05.2026)
- ✅ Упрощена загрузка IRDB - теперь загружаются 3 популярных устройства (Samsung, LG, Sony TV)
- ✅ Исправлена ошибка HTTP 404 при загрузке баз данных
- ✅ Добавлен ScalarsConverterFactory для Retrofit

### v1.0.1 (01.05.2026)
- ✅ Добавлена поддержка проприетарных IR API производителей (Xiaomi, Samsung)
- ✅ Добавлен fallback через reflection для скрытых API
- ✅ Улучшено логирование с информацией о производителе устройства

### v1.0.0 (01.05.2026)
- ✅ Исправлена ошибка компиляции (SettopBox icon)
- ✅ Исправлены URL для загрузки IRDB (HTTP 404)
- ✅ Добавлено логирование для диагностики IR передатчика
- ✅ Исправлена ошибка test reporter в CI
- ✅ Добавлено разрешение TRANSMIT_IR для IR передатчика
- ✅ Настроены автоматические релизы при каждом push в main
- ✅ Исправлена проблема с установкой APK (используется debug сборка)
- ✅ Добавлены разрешения для создания релизов в GitHub Actions
